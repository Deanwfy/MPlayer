...
public abstract class GeneralRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<T> list;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (onRecyclerItemClickLitener != null) {
            holder.itemView.setOnClickListener(view -> onRecyclerItemClickLitener.onRecyclerItemClick(holder, position));
